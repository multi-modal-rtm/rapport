...
As a robustness check against the context-free fine-tuned endpoint (k=0, n=7) instead of the locked recipe: DiD = **+0.0429**, 95% CI **[+0.0307, +0.0568]**, excludes zero. Both comparators agree in direction and in excluding zero.
...
- Fine-tuned k=0 paired diffs (n=7): `[-0.0007683198328711782, -0.0040295696320173935, -0.0020021013074479344, -0.032199583369822316, 0.0055468621334249235, -0.016201056844462935, -0.0008246104059453918]`
